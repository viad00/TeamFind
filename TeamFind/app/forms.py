...
class AddTeamForm(forms.Form):
    ...
    is_mm = forms.BooleanField(label=settings.TYPES['MM'], initial=True, required=False)
    is_pu = forms.BooleanField(label=settings.TYPES['PU'], initial=False, required=False)
    is_le = forms.BooleanField(label=settings.TYPES['LE'], initial=False, required=False)
    is_ca = forms.BooleanField(label=settings.TYPES['CA'], initial=True, required=False)
